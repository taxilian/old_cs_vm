...
;
PSTR        LD R8, R2           ; Print String function; start by loading the start
                                ; char into R0 (*R2 -> R0)
            BRZ R8, PSTR_E      ; When the loaded char is 0, go to PSTR_E
            TRP 3               ; Print the character
            ADI R2, 1           ; Move R2 to the next item
...
;      on the screen.  Put 2 spaces between each result.
            ...
            LD R0, R2           ; Load the first item in the list
            ADI R2, 1           ; Move to the second item to sum it
STEP2       LD R1, R2           ; Load the current item into R1
            ...
            ADI R2, 1           ; Move to the next int item in the list
...
;      final) on the screen.  Put 2 spaces between each result.
            ...
            LDR R8, SPACE       ; Get a space ready to print
            LD R0, R2           ; Zero out R0
            ADI R2, 1           ; Add 1 to R0; this will contain our product
STEP5       LD R1, R2           ; Load the current item into R1
...
STEP7       MOV R0, R5          ; Load the result from part 3 into R0
            LD R1, R2           ; Load the current item into R1
